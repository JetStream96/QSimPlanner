...
namespace QSP.UI.Models.Wind
{
    public class WindDownloadStatus
    {
        ...
        public static WindDownloadStatus FinishedDownload
        {
            get
            {
                return new WindDownloadStatus("Lastest wind ready", Properties.Resources.GreenLight);
            }
        }
        ...
        public static WindDownloadStatus Downloading
        {
            get
            {
                return new WindDownloadStatus("Downloading lastest wind ...", null);
            }
        }
