...
namespace QSP.AviationTools.Coordinates
{
    public static class FormatDegreeMinute
    {
        ...
        public static string LatToDegreeMinuteFormat(double lat, string format = "F2")
        {
        ...
        // N25° 4.39', E121° 12.97'
        public static string LonToDegreeMinuteFormat(double lon, string format = "F2")
        {
        ...
        public static string ToDegreeMinuteFormat(double d, string format = "F2")
        {
            if (d < 0.0) d = -d;
