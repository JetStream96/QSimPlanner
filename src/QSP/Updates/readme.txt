...
3. Take all files in src\Installer\Output\[version]. Zip all contents in to a single file. Make sure the top level of the zip file contains QSimPlanner.exe instead of a folder.
...
6. Upload info.xml to those uris listed in src\QSP\updater.xml.