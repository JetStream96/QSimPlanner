...
AppName=QSimPlanner
AppVersion=
DefaultDirName={localappdata}\QSimPlanner
DefaultGroupName=QSimPlanner
UninstallDisplayIcon={app}\QSimPlanner.exe  
Compression=lzma2
...
[Icons]
Name: "{group}\QSimPlanner"; Filename: "{app}\Launcher.exe"
Name: "{userdesktop}\QSimPlanner"; Filename: "{app}\Launcher.exe"
